...
import { GETH_NETWORK_USDC_ADDRESS, GETH_NETWORK_WETH_ADDRESS } from '../geth_network'
...
// export const DAI_GETH_NETWORK = new Token(
//   SupportedChainId.GETH_NETWORK,
//   GETH_NETWORK_DAI_ADDRESS,
//   18,
//   'DAI',
//   'Dai stable coin'
// )
...
export const USDC: { [chainId in SupportedChainId]: Token } = {
  ...
  [SupportedChainId.GETH_NETWORK]: USDC_GETH_NETWORK,
}
...
export const WRAPPED_NATIVE_CURRENCY: { [chainId: number]: Token | undefined } = {
  ...
  [SupportedChainId.GETH_NETWORK]: new Token(
    SupportedChainId.GETH_NETWORK,
    GETH_NETWORK_WETH_ADDRESS,
    18,
    'WETH',
    'Wrapped Eth'
  ),
