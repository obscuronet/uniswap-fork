...
import {
  GETH_NETWORK_MULTICALL_ADDRESS,
  GETH_NETWORK_QUOTER_ADDRESSES,
  GETH_NETWORK_V3_CORE_FACTORY_ADDRESSES,
...
export const V3_CORE_FACTORY_ADDRESSES: AddressMap = {
  ...
  [ChainId.GETH_NETWORK]: GETH_NETWORK_V3_CORE_FACTORY_ADDRESSES,
...
export const QUOTER_V2_ADDRESSES: AddressMap = {
  ...
  [ChainId.GETH_NETWORK]: GETH_NETWORK_QUOTER_ADDRESSES,
...
export const UNISWAP_MULTICALL_ADDRESSES: AddressMap = {
  ...
  [ChainId.GETH_NETWORK]: GETH_NETWORK_MULTICALL_ADDRESS,
